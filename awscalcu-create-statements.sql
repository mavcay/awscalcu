	...
	agent_usage DECIMAL(10,4) DEFAULT NULL, -- logic_aza input
	...
	-- Load Region Data
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/region.csv'
	INTO TABLE region
	...
	-- Load Country Data
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/country.csv'
	INTO TABLE country
	FIELDS TERMINATED BY ','  
	OPTIONALLY ENCLOSED BY '"'
	LINES TERMINATED BY '\n';
	...
	-- Load Call Type Data
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/call_type.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/connect_service.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_vv.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_mc.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_em.csv'
	...
	-- Load Calculation Logic EM Data
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_tk.csv'
	INTO TABLE calculation_logic_tk
	FIELDS TERMINATED BY ','  
	OPTIONALLY ENCLOSED BY '"'
	LINES TERMINATED BY '\n';

	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_azq.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_cs.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_gd.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_aza.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_vid.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator/backend/awscalcu-csv/calculation_logic_cp.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_acs.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_cl.csv'
	...
	LOAD DATA INFILE 'D:/Academic Files/Practicum/Tasks/Amazon Connect Service Calculator Backend/backend/awscalcu-csv/calculation_logic_fs.csv'
